...
// Use require with proper typing to avoid TypeScript issues
const flattenColorPalette = require("tailwindcss/lib/util/flattenColorPalette") as (colors: any) => Record<string, string>;
