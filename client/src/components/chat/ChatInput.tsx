      ...
      <form onSubmit={handleSubmit} className="flex gap-2 items-end max-w-4xl mx-auto">
        <div className="flex-1 relative">
          <Textarea
            ...
            className="min-h-[56px] md:min-h-[65px] max-h-32 pe-12 text-base md:text-lg !bg-neutral-900/20 border-neutral-800 shadow-[0_0_5px_#1EAEDB80] resize-none text-white placeholder:text-white/50 border-none focus-visible:ring-background focus-visible:ring-1 outline-background "
            disabled={isLoading}
          />
