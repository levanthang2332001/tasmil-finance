...
import ScrollableModules from "./ScrollableModules";
...
const Trending = () => {
  return (
    <>
      ...
      >
        <ScrollableModules modules={modules as Module[]} />
      </motion.div>
      ...
      >
        <TraderSection title="Top Traders" traders={topTraders as Trader[]} />
        <TraderSection title="Top Whales" traders={topWhales as Trader[]} />
      </motion.div>
    </>
  );
};
